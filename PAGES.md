...
| 紙雪の結晶スタジオ（Kirigami Snowflake Studio） | 「折る→切る→開く」の紙工作手順を疑似体験しながら六角対称の切り紙雪結晶をデザインし、ハサミで作れるSVG型紙とPNG完成イメージを書き出せるツール | [Pages](https://oplan-development-team.github.io/web-app-factory/kirigami-snowflake-studio/) | プロトタイプ（採否待ち・マージ待ち） | 2026-09-08 |
