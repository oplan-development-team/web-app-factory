...
- [x] **T33** FLOW: 場による歪みと点描レイヤー（Flow Dots 相当） — FR-110
- [x] **T34** RADIAL: 複数の渦中心による干渉した同心円 — FR-110
- [x] **T35** GRID / NOISE: 場による格子の歪みと密度の偏り — FR-110
- [x] **T36** 不変条件テストの更新と、12 型のコンタクトシートによる目視確認 — AC-09〜11

## Phase H — 再検証

- [x] **T37** 統合 / E2E の更新と全緑化、カバレッジ維持 — AC-17〜29
- [x] **T38** `visual-qa` 再実行と指摘の修正、`docker build` 再確認、ドキュメント更新
