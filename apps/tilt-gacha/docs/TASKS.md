...
- [ ] **T29** 待機画面をモックアップ構成へ（左上ワードマーク・中央ゴースト+コピー・ピル型ボタン・傾きアイコン列・図鑑リンク） — FR-300 系
- [ ] **T30** 出現演出をモックアップ構成へ（上部バー TYPE nn/12・中央グロー・識別ブロック・CTA 2 つ横並び） — FR-400 系
- [ ] **T31** 図鑑をモックアップ構成へ（角丸スロット 104px・3 列・locked 面/破線・進捗バー） — FR-500 系
