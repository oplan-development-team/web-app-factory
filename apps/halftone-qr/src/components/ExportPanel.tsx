  ...
  return (
    <section className="panel export-panel">
      ...
      <div className="panel-body">
        ...
        {/*
          等倍のソフトウェアデコードで失敗しうるのは、この方式が
          カメラの光学的なぼけ（＝縮小による平均化）を前提にしているため。
          知らないと「壊れた PNG が出た」と誤解されるので明示する。
        */}
        <p className="field-hint">
          書き出した PNG を画像ファイルのままデコーダに渡すと失敗することがあります。
          ハーフトーン QR はカメラの光学的なぼけを前提とする方式のため、
          カメラで撮って読み取るか、縮小してから読ませてください。
        </p>
